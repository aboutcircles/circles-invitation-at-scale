...
/// @title Circles Invitation Module
/// @notice A Safe module and Hub organization that automates human registration in the Circles Hub through a single-transaction invitation flow.
/// @dev
/// This contract serves dual roles:
/// - **Safe module** — enabled on individual human Safes.
/// - **Hub organization** — registered in the Circles Hub.
/// The module extends the base Hub invitation logic by integrating the Hub’s trust model.
/// This enables invitations to originate either directly or indirectly through proxies that trust the origin inviter.
